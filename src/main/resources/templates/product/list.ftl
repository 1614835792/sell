        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                ...
                <tr>
                    ...
                    <td><a href="/sell/seller/product/index?productId=${productInfo.productId}">修改</a><br></td>
                    <td>
                       <#if productInfo.getProductStatusEnum().message=="在架">
                             <a href="/sell/seller/product/off_sale?productId=${productInfo.productId}">下架</a><br>
                      <#else>
                           <a href="/sell/seller/product/on_sale?productId=${productInfo.productId}">上架</a><br>
                       </#if>
                    </td>
                </tr>
                </#list>
                ...
                <#--分页-->
                 ...
                 <#else>
                     <li><a href="sell/seller/product/list?page=${currentPage-1}&size=${size}"></a></li>
                 </#if>
