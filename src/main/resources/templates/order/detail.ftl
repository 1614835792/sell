    ...
    <div id="page-content-wrapper">
        <div class="container">
            <div class="row clearfix">
                ...
                <tr>
                    <td>${orderDetil.productId}</td>
                    <td>${orderDetil.productName}</td>
                    <td>${orderDetil.productPrice}</td>
                    <td>${orderDetil.productQuantity}</td>
                    <td>${orderDetil.productQuantity*orderDetil.productPrice}</td>
                </tr>
                </#list>
                        </tbody>
                    </table>
